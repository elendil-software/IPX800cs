Copyright (c) 2015-2018 Julien Tschäppät
...
IPX800 C# is a library that allows to control the output and read the input of an IPX800 v3 or IPX800 v2 from GCE Electronic (http://www.gce-electronics.com)
Note : GCE Electronics is a registered trademark.
