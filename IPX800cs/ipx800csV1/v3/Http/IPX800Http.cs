...
namespace software.elendil.IPX800.ipx800csV1.v3.Http
{
	/// <summary>
	/// IPX800 v3 HTTP implementation for firmware 3.05.42 and above
	/// </summary>
	public class IPX800Http : IPX800HttpBase
	{
		#region Constructors
