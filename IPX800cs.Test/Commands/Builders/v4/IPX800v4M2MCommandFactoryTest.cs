...
public class IPX800v4M2MCommandFactoryTest
{
    private readonly IPX800v4M2MCommandFactory _commandFactory = new();
    
    #region GetInputCommand
    
    public static IEnumerable<object[]> SupportedGetInputTestCases => new[]
    {
        new object[] { new Input { Number = 2, Type = InputType.DigitalInput}, "Get=D" },
        new object[] { new Input { Number = 2, Type = InputType.AnalogInput}, "Get=A" },
        new object[] { new Input { Number = 2, Type = InputType.VirtualAnalogInput}, "Get=VA" },
        new object[] { new Input { Number = 2, Type = InputType.VirtualDigitalInput}, "Get=VI" },
    };
    ...
    [Theory]
    [InlineData(InputType.AnalogInput, "Get=A")]
    [InlineData(InputType.DigitalInput, "Get=D")]
    [InlineData(InputType.VirtualAnalogInput, "Get=VA")]
    [InlineData(InputType.VirtualDigitalInput, "Get=VI")]
    ...
    {
        new object[] { new Output { Number = 2, Type = OutputType.Output}, "Get=R" },
        new object[] { new Output { Number = 2, Type = OutputType.VirtualOutput}, "Get=VO" },
    };
    ...
    [Theory]
    [InlineData(OutputType.Output, "Get=R")]
    [InlineData(OutputType.VirtualOutput, "Get=VO")]
    ...
    {
        new object[] { new Output {Type = OutputType.Output, Number = 2, State = OutputState.Active, IsDelayed = false }, "SetR=02" },
        new object[] { new Output {Type = OutputType.Output, Number = 2, State = OutputState.Active, IsDelayed = true }, "SetR=02" },
        new object[] { new Output {Type = OutputType.Output, Number = 2, State = OutputState.Inactive, IsDelayed = false }, "ClearR=02" },
        new object[] { new Output {Type = OutputType.Output, Number = 2, State = OutputState.Inactive, IsDelayed = true }, "ClearR=02" },
        new object[] { new Output {Type = OutputType.VirtualOutput, Number = 2, State = OutputState.Active, IsDelayed = false }, "SetVO=02" },
        new object[] { new Output {Type = OutputType.VirtualOutput, Number = 2, State = OutputState.Active, IsDelayed = true }, "SetVO=02" },
        new object[] { new Output {Type = OutputType.VirtualOutput, Number = 2, State = OutputState.Inactive, IsDelayed = false }, "ClearVO=02" },
        new object[] { new Output {Type = OutputType.VirtualOutput, Number = 2, State = OutputState.Inactive, IsDelayed = true }, "ClearVO=02" }
    };
